package asl
 ...
 class ponger  (coms: AgentCommunicationLayer = new  DefaultCommunications,
 ...
 class Agent extends IAgent {
         ...
         override def agent_type: String = "ponger"
...
object ponger_companion { 
   def create() = new ponger().agentBuilder 
   def create(in_coms : AgentCommunicationLayer) = new ponger(coms = in_coms).agentBuilder 
   def create(in_beliefBaseFactory: IBeliefBaseFactory) = new ponger(beliefBaseFactory = in_beliefBaseFactory).agentBuilder 
   def create(in_coms : AgentCommunicationLayer, in_beliefBaseFactory: IBeliefBaseFactory) = new ponger(coms = in_coms, beliefBaseFactory = in_beliefBaseFactory).agentBuilder 
} 

package asl
 ...
 class droneA  (coms: AgentCommunicationLayer = new  DefaultCommunications,
         ...
         message match {
            case SubGoalMessage(_,_,r) =>
               message.goal match {
                   ...
                   case droneA.this.adopt_achievement_start_0 =>
                     droneA.this.adopt_achievement_start_0.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_belief_antidronefire_2 =>
                     droneA.this.adopt_belief_antidronefire_2.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_radar_0 =>
                     droneA.this.adopt_achievement_radar_0.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_belief_targeting_3 =>
                     droneA.this.adopt_belief_targeting_3.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_moveup_0 =>
                     droneA.this.adopt_achievement_moveup_0.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_movedown_0 =>
                     droneA.this.adopt_achievement_movedown_0.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_moveleft_0 =>
                     droneA.this.adopt_achievement_moveleft_0.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_moveright_2 =>
                     droneA.this.adopt_achievement_moveright_2.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_whereIam_2 =>
                     droneA.this.adopt_achievement_whereIam_2.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_target_2 =>
                     droneA.this.adopt_achievement_target_2.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_belief_attacked_1 =>
                     droneA.this.adopt_belief_attacked_1.execute(message.params.asInstanceOf[Parameters])

                   case droneA.this.adopt_achievement_additionaltasks_0 =>
                     droneA.this.adopt_achievement_additionaltasks_0.execute(message.params.asInstanceOf[Parameters])
 ...
 class Agent extends IAgent {
         ...
         override def agent_type: String = "droneA"
         ...
         def initBeliefs()(implicit executionContext: ExecutionContext) = List[StructTerm](
                     StructTerm(":-",Seq[GenericTerm](StructTerm("around",Seq[GenericTerm](vars("X"),vars("Y"))),StructTerm(",",Seq[GenericTerm](StructTerm(",",Seq[GenericTerm](StructTerm(",",Seq[GenericTerm](StructTerm(",",Seq[GenericTerm](StructTerm("at",Seq[GenericTerm](vars("Z"),vars("T"))),StructTerm("<",Seq[GenericTerm](vars("X"),StructTerm("+",Seq[GenericTerm](vars("Z"),IntTerm(1))))))),StructTerm(">",Seq[GenericTerm](vars("X"),StructTerm("-",Seq[GenericTerm](vars("Z"),IntTerm(1))))))),StructTerm("<",Seq[GenericTerm](vars("Y"),StructTerm("+",Seq[GenericTerm](vars("T"),IntTerm(1))))))),StructTerm(">",Seq[GenericTerm](vars("Y"),StructTerm("-",Seq[GenericTerm](vars("T"),IntTerm(1)))))))))
           ,
            StructTerm("initial",Seq[GenericTerm](IntTerm(3),IntTerm(1)))
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          PrimitiveAction.execute(PrimitiveAction.Parameters(() => println(StringTerm("droneA starting"))))
                                          ...
                                          adopt_achievement_moveup_0.execute(Parameters(List(  )))
                                          adopt_achievement_radar_0.execute(Parameters(List(  )))
                                          adopt_achievement_additionaltasks_0.execute(Parameters(List(  )))
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          PrimitiveAction.execute(PrimitiveAction.Parameters(() => coms.inform(StructTerm("droneC",Seq[GenericTerm]()),StructTerm("attacked",Seq[GenericTerm](vars("Self"))))))
        ...
        def execute(params: Parameters) (implicit executionContext: ExecutionContext) : Unit = {
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
                 ...
                 //plan 0 start
                         ...
                         vars("Source").bind_to(StringTerm(executionContext.src.name))
                         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
                         val r0 = executionContext.beliefBase.query(StructTerm(",",Seq[GenericTerm](StructTerm("not",Seq[GenericTerm](StructTerm("destroyed",Seq[GenericTerm](BooleanTerm(true))))),StructTerm("problems",Seq[GenericTerm](StructTerm("droneB",Seq[GenericTerm]()))))))
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          PrimitiveAction.execute(PrimitiveAction.Parameters(() => println( (StructTerm("self",Seq[GenericTerm]()) + StringTerm(" is going to replace droneB ")) )))
...
object droneA_companion { 
   def create() = new droneA().agentBuilder 
   def create(in_coms : AgentCommunicationLayer) = new droneA(coms = in_coms).agentBuilder 
   def create(in_beliefBaseFactory: IBeliefBaseFactory) = new droneA(beliefBaseFactory = in_beliefBaseFactory).agentBuilder 
   def create(in_coms : AgentCommunicationLayer, in_beliefBaseFactory: IBeliefBaseFactory) = new droneA(coms = in_coms, beliefBaseFactory = in_beliefBaseFactory).agentBuilder 
} 
